      ...
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <motion.p
                  ...
                  variants={fadeInUp}
                >
                  Discover relevant funding instantly, explore over 20,000
                  expert-curated grants, and find best-fit funders from a
                  database of over 400,000.
                </motion.p>
                <motion.div
        ...
        >
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-gray-500">
              Join thousands of successful founders who have secured funding and
              grown their business with Human
            </p>
            <Link
              href="/auth/register"
            ...
            {[
              {
                ...
                sublabel: "To innovative startups",
              },
              {
                number: "1000+",
                label: "Startups Funded",
                sublabel: "Across all sectors",
              },
              {
                number: "500+",
                label: "Active Grants",
                sublabel: "Ready to guide you",
              },
              {
                number: "95%",
                label: "Success Rate",
                sublabel: "In securing funding",
              },
            ].map((stat, i) => (
              <motion.div
                key={i}
            ...
            {[
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    href="/grants"
                    className="text-orange-600 text-sm hover:text-orange-600"
                  >
                    Learn More →
                  </Link>
                </div>
        ...
        <section className="bg-[#0B1121] text-white">
          ...
          >
            ...
            <motion.p className="text-gray-400 mb-8" variants={fadeInUp}>
              Join thousands of founders who have successfully secured funding
              through Human Levered
            </motion.p>
