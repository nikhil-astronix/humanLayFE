    ...
    <div className="bg-white rounded-lg p-8 space-y-8">
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg text-gray-600 mb-3">{data.industry}</p>
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        <h2 className="text-xl font-semibold text-gray-900 ">Grant Award Details</h2>
        <div className="grid grid-cols-2 gap-8  py-4">
          <div>
            <p className="text-sm font-medium text-gray-500">Grant Amount</p>
            <p className="mt-2 text-2xl font-semibold text-gray-900">{data.grantDetails.amount}</p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-500">Award Date</p>
            <p className="mt-2 text-2xl font-semibold text-gray-900">{data.grantDetails.awardDate}</p>
          </div>
        </div>
      </div>
