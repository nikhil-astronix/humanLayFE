  ...
  const roles = [
    {
      id: "grant-seeker",
      title: "Grant Seeker",
      description: "For startup founders and small business owners seeking funding and resources",
      icon: Rocket,
      features: [
    ...
    },
    {
      ...
      description: "For program officers and organizations managing grant programs",
      icon: Building2,
      features: [
