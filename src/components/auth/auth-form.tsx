          ...
          <div className="w-full space-y-6 mt-8">
            {currentStep === 1 ? (
                ...
                {selectedRole === "grant-provider" ? (
                  ...
                  <div className="shadow-lg rounded-lg p-8 border border-gray-200">
                    <div className="text-center">
                      <h2 className="text-2xl font-bold text-gray-900">Create Grant Provider Account</h2>
                      <p className="mt-2 text-sm text-gray-600">
                        Join our platform to manage grant applications and connect with founders
                      </p>
                    </div>

                    <form onSubmit={handleProviderSubmit(onProviderSubmit)} className="mt-8 space-y-6">
                      <div>
                        ...
                        {providerErrors.email && (
                          <p className="mt-1 text-sm text-red-600">{providerErrors.email.message}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {providerErrors.password && (
                          <p className="mt-1 text-sm text-red-600">{providerErrors.password.message}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {providerErrors.confirmPassword && (
                          <p className="mt-1 text-sm text-red-600">{providerErrors.confirmPassword.message}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {providerErrors.organizationType && (
                          <p className="mt-1 text-sm text-red-600">{providerErrors.organizationType.message}</p>
                        )}
                      </div>
              ...
              <div className="max-w-xl mx-auto border border-gray-200 rounded-lg p-8 shadow-lg">
                ...
                <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-4 mt-8">
                  <div>
